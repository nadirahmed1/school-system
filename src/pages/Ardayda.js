  ...
  const save = async () => {
    ...
    try {
      ...
      if (editId) {
        ...
        error = res.error
        if (!error) setMsg('✅ Arday cusub la daray!')
      }
      if (error) {
        setMsg('❌ Khalad: ' + error.message)
      } else {
      ...
      reader.onload = async (evt) => {
        try {
          ...
          const ardaydaNew = rows.map((row, i) => {
            ...
            const hooyo = String(row['Magaca Hooyada'] || row['hooyo_magac'] || '').trim()
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="student-info">
                ...
                <div class="info-line">👩 Hooyada: <span>${a.hooyo_magac || a.aabaha_magac || '—'}</span></div>
