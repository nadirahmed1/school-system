...
// Bedel localStorage → Supabase/Firebase haddaad backend leedahay
// ============================================================
...
function getSchoolSettings() {
  ...
  return d ? JSON.parse(d) : {
    ...
    logoUrl: null,       // base64 string ama URL
    primaryColor: "#1a3a5c",
    accentColor: "#065f46",
    sidebarColor: "#1a3a5c",
  };
...
function saveSchoolSettings(settings) {
  ...
  // CSS variables si toos ah u cusboonaysii
  applyCSSVariables(settings);
  // Custom event si components kale u ogaadaan
...
// Ku dar index.css ama App.js hoos:
// :root { --primary: #1a3a5c; --accent: #065f46; --sidebar: #1a3a5c; }
...
// ============================================================
// PASSWORD CHANGE COMPONENT (existing - unchanged)
// ============================================================
function PasswordChange() {
  ...
  function handleSubmit() {
    ...
    const stored = localStorage.getItem("admin_password") || "Admin@2024";
    if (form.old !== stored) { setMsg("❌ Password-kii hore waa khalad."); return; }
    localStorage.setItem("admin_password", form.new_);
...
// ============================================================
// SCHOOL NAME COMPONENT (existing - enhanced)
// ============================================================
