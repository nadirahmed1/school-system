...
export default function Lacagta({ user }) {
  ...
  // Raadi ID-ka bisha la doortay kaliya
  const searchAllMonths = useCallback(async (query, bisha, sannad) => {
  ...
  useEffect(() => {
    searchAllMonths(idSearch, filterBisha, filterSannad)
  }, [idSearch, filterBisha, filterSannad, searchAllMonths])
