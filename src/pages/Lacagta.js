...
export default function Lacagta({ user }) {
  ...
  const printReceipt = (lacag) => {
    if (lacag._virtual) return  // Ma bixin rows print-ka kuma jiraan
...
<div class="info-row"><span class="info-label">📆 Taariikhda Bixinta</span><span class="info-value">${taariikhBixin}</span></div>
</div>
...
<div class="status-box status-paid">✅ LACAGTA WAA LA BIXIYAY</div>
