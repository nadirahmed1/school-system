...
export default function Dashboard({ user }) {
  ...
  // Ardada bisha lacag u ma leh (missing) = ardada guud - ardada bisha ku jira
  const ardadaBishaKuJira = bishaSelected.tiradaBixiyay + bishaSelected.tiradaMaBixin
  const ardadaMissingBisha = Math.max(0, ardaydaCount - ardadaBishaKuJira)

  // Ma Bixin dhabta ah = kuwa lacag $0 / false + kuwa missing
  const tiradaMaBixinDhabta = bishaSelected.tiradaMaBixin + ardadaMissingBisha
